...
const enTranslations = {
  ...
  callToAction: {
    title: "Travel without limit",
    description: "Discover the beauty of Uganda with our guided tours and safari experiences.",
...
const zhTranslations = {
  ...
  callToAction: {
    title: "无限制旅行",
    description: "为您的旅行找到合适的电子签证，轻松申请，几分钟内完成。",
    passport: "您的护照",
