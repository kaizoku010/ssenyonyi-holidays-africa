    ...
    <div className="packages-page">
      <header className="packages-hero">
        ...
        <div className="hero-content">
          ...
          <p>Explore our carefully crafted experiences across East Africa</p>
        </div>
      </header>
        ...
        <div className="featured-packages">
          ...
          <div className="featured-grid">
            {packages.filter(pkg => pkg.featured).map(pkg => (
              <div key={pkg.id} className="featured-package-card">
...
const PackageCard = ({ packageData }) => {
  return (
    <Card className="card package-card">
      <div className="card-image" style={{ backgroundImage: `url(${packageData.image})` }}>
        <div className="package-type">{packageData.type}</div>
      </div>
      <CardHeader className="card-header">
        <CardTitle className="card-title">{packageData.title}</CardTitle>
        <CardDescription className="card-description">{packageData.duration}</CardDescription>
      </CardHeader>
      <CardContent className="card-content">
        <div className="package-destinations" title={packageData.destinations.join(" → ")}>
        ...
        <div className="package-accommodation">
          <h4>Accommodation:</h4>
          <p className="truncate-text">{packageData.accommodation}</p>
        </div>
        <div className="package-inclusions">
          <h4>Inclusions:</h4>
          <p className="truncate-text">{packageData.inclusions}</p>
        </div>
      </CardContent>
