              ...
              {paymentStep === 1 && (
                <div className="package-details-payment-step">
                  ...
                  <div className="form-buttons">
                    <Button type="button" className="button" onClick={() => setShowPaymentModal(false)}>Cancel</Button>
                    <Button type="button" className="button book-now-button" onClick={nextStep}>Next</Button>
                  </div>
                </div>
              )}
