    ...
    <div className="packages-page">
      ...
      <main className="packages-content">
        ...
        <div className="all-packages">
          ...
          <Tabs defaultValue="all" className="packages-tabs" onValueChange={setActiveTab}>
            ...
            <TabsContent value="all" className="packages-grid">
              {filteredPackages.map(pkg => (
                <PackageCard key={pkg.id} packageData={pkg} />
              ))}
            </TabsContent>

            <TabsContent value="mid-range" className="packages-grid">
              {filteredPackages.map(pkg => (
                <PackageCard key={pkg.id} packageData={pkg} />
              ))}
            </TabsContent>

            <TabsContent value="high-end" className="packages-grid">
              {filteredPackages.map(pkg => (
                <PackageCard key={pkg.id} packageData={pkg} />
              ))}
            </TabsContent>
  ...
  return (
    <Card className="package-card">
      ...
      <CardHeader>
        ...
        <CardDescription>{packageData.duration}</CardDescription>
      </CardHeader>
      <CardContent>
