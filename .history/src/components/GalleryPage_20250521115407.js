      ...
      <main className="gallery-content">
        ...
        >
          {isLoading ? (
            ...
            // Actual gallery items - only show visibleItems number of items
            filteredImages.slice(0, visibleItems).map(image => (
              <div
                key={image.id}
              ...
              >
                ...
                <div className="image-container">
                  <div className={`image-placeholder ${loadedImages[image.id] ? 'hidden' : ''}`}></div>
                  <img
                    src={image.src}
                    alt={image.alt}
                    loading="lazy"
