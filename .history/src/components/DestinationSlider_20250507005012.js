    ...
    <div className="destination-slider">
      ...
      <dialog id="booking-modal" className="booking-modal">
        <div className="booking-modal-content">
          ...
          <form action="https://formspree.io/f/xnnddyzv" method="POST">
            ...
            <div className="form-group">
              ...
              <select id="destination" name="destination" required>
                ...
                <option value="Switzerland Alps">Switzerland Alps</option>
                <option value="Mount Kilimanjaro">Mount Kilimanjaro</option>
                <option value="Uganda Safari">Uganda Safari</option>
                <option value="Rwanda Gorilla Trek">Rwanda Gorilla Trek</option>
              </select>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="number" id="travelers" name="travelers" min="1" defaultValue="2" required />
            </div>
            <div className="form-group">
            ...
            <div className="form-actions">
              <button type="button" onClick={() => document.getElementById('booking-modal').close()}>Cancel</button>
