  ...
  useEffect(() => {
    ...
    const setupAnimation = () => {
      ...
      ScrollTrigger.create({
        ...
        snap: {
          snapTo: (value, scrollTrigger) => {
            // Calculate which panel we're closest to
            const panelIndex = Math.round(value * (featuredExperiences.length - 1));
