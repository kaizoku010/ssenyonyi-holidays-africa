...
import Kivu from '../media/kivu.jpg';
import Kivu3 from '../media/kivu3.jpg';
import Kivu2 from '../media/kivu2.jpg';import kitandra from "../media/kitandra.jpg";
    ...
    <Card className="card destination-card mdx-card">
      ...
      <CardFooter className="card-footer">
        <Link to={`/destination/${destination.id}`}>
          <Button className="explore-button">{t('destinationsPage.card.explore')}</Button>
        </Link>
      </CardFooter>
    </Card>
  );
