...
const FeaturedAdventures = () => {
  ...
  // Create individual transform values for each adventure at the top level
  const yProgress0 = useTransform(scrollYProgress, [0, 1], [0 * 100, -100 + 0 * 50]);
  const yProgress1 = useTransform(scrollYProgress, [0, 1], [1 * 100, -100 + 1 * 50]);
  const yProgress2 = useTransform(scrollYProgress, [0, 1], [2 * 100, -100 + 2 * 50]);
  const yProgress3 = useTransform(scrollYProgress, [0, 1], [3 * 100, -100 + 3 * 50]);
      ...
      <div className="adventures-container">
        ...
        <div className="adventures-scroll-container">
          {adventures.map((adventure, index) => {
            ...
            const yProgress = yProgressValues[index];
