    ...
    <section className="about-section">
      <div className="about-container">
        <div className="about-content">
          ...
          <button className="about-button" onClick={handleLearnMoreClick}>{t('homePage.callToAction')}</button>
        </div>
        <div className="about-image">
          <img src={kitandra} alt="Nyonyi Holidays Africa Experience" />
          <div className="image-overlay">
            <div className="overlay-content">
              <h3>{t('homePage.about.discover.title')}</h3>
              <p>{t('homePage.about.discover.subtitle')}</p>
            </div>
          </div>
        </div>
      </div>
