...
const AboutSection = () => {
  ...
  // Modal content component to keep the main component cleaner
  const AboutModal = () => (
    <motion.div
            ...
            <ul className="travel-reasons">
              ...
              <li>
                ...
                <div>
                  ...
                  <p>We adhere to strict guidelines to minimize ecological impact during gorilla treks.</p>
                </div>
              </li>
            </ul>
          </div>
