...
import { Caimport packages from '../data/packages.json';rd, CardContent, CardHeader, CardTitle, CardDescription, CardFooter } from './ui/card';
    ...
    <div className="packages-page">
      <header className="packages-hero">``
        ...
        <div className="hero-content hero-content-new">
          ...
          <h1 className='packages-header'>{t('packagesPage.title', 'Safari packages & destinations')}</h1>
          <p style={{ fontSize: ".9rem"}}>{t('packagesPage.subtitle', 'Explore our carefully crafted experiences across East Africa')}</p>
        </div>
        </div>
      </header>
        ...
        <div className="all-packages">
          ...
          <Tabs defaultValue="all" className="tabs packages-tabs" onValueChange={setActiveTab}>
            <TabsList className="tabs-list">
              <TabsTrigger className="tabs-trigger" value="all">{t('packagesPage.tabs.all', 'All Packages')}</TabsTrigger>
              <TabsTrigger className="tabs-trigger" value="mid-range">{t('packagesPage.tabs.midRange', 'Mid-Range')}</TabsTrigger>
              <TabsTrigger className="tabs-trigger" value="high-end">{t('packagesPage.tabs.highEnd', 'High-End')}</TabsTrigger>
            </TabsList>
