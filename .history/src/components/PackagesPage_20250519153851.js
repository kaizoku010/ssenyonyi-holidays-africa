    ...
    <div className="packages-page">
      <header className="packages-hero">
        ...
        <div className="hero-content hero-content-new">
          ...
          <h1 className='packages-header'>Safari Packages & Destinations</h1>
          <p style={{ fontSize: ".8rem", opacity: "0.9" }}>Explore our carefully crafted experiences across East Africa</p>
        </div>
        </div>
      </header>
              ...
              <div key={pkg.id} className="featured-pkg-card">
                ...
                <div className="pkg-details">
                  ...
                  <Link to={`/packages/${pkg.id}`} className="view-details-link">
                    <button className="book-button-new">View Details</button>
                  </Link>
                </div>
              </div>
            ))}
