...
import Kivu from '../media/kivu2.jpg';
import Kivu3 from '../media/kivu3.jpg';
import Kivu2 from '../media/kivu2.jpg';
import Mach from '../media/mach.jpg';
import Swril from '../media/swril.jpg';
import slide3 from '../media/slide3.jpg';
import Eles from '../media/eles.jpg';
import Eliz from '../media/eliz.jpg';
import Buh from '../media/buh.jpg';
import Eles from '../media/bw.jpg';
import Eliz from '../media/bw2.jpg';
...
const DestinationDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    if (destData) {
      ...
      document.title = `${destData.name} | Nyonyi Holidays Africa`;
    }
  }, [id]);
    ...
    <div className="package-details-page">
      <header className="details-hero-">
        ...
        <div className="hero-content-destination">
          ...
          <p className='destiation-header-desc'>Discover the natural wonders and cultural treasures of Africa</p>
