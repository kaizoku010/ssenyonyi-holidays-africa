...
const PackageDetailsPage = () => {
  ...
  return (
    <div className="package-details-page">
      ...
      style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${selectedPackage.image})` }}>
        <Navbar />
      ...
      <main className="details-content">
        <div className="details-overview">
          ...
          {/* <div className="package-details-booking-card">
            <Card className="package-details-card" id="booking-sidebar-card">
              <CardHeader className="package-details-card-header">
                <CardTitle className="package-details-card-title">Book This Package</CardTitle>
              </CardHeader>
              <CardContent className="package-details-card-content">
                <div className="package-details-price-container">
                  <span className="package-details-price-label">From</span>
                  <span className="package-details-price-value">${selectedPackage.price}</span>
                  <span className="package-details-price-unit">per person</span>
                </div>
                <div className="package-details-booking-details">
                  <div className="package-details-booking-detail">
                ...
                <Button className="package-details-button package-details-book-now-button" onClick={() => setShowPaymentModal(true)}>
                  Book Now
                </Button>
                <div className="package-details-booking-contact">
                  <p>Need help or have questions?</p>
                  <a href="tel:+256700000000" className="package-details-contact-link">
              
                  </a>
                  <a href="mailto:info@deriqtravels.com" className="package-details-contact-link">
      ...
      {showPaymentModal && (
        <div className="package-details-payment-modal-overlay">
          <div className="package-details-payment-modal" id="package-payment-modal">
            <button className="package-details-close-modal" onClick={() => setShowPaymentModal(false)}>
              <i className="fas fa-times"></i>
            </button>

            <div className="package-details-payment-header">
              <h2>Book Your Safari</h2>
              <div className="package-details-payment-steps">
                <div className={`package-details-step ${paymentStep >= 1 ? 'active' : ''}`}>1. Details</div>
                <div className={`package-details-step ${paymentStep >= 2 ? 'active' : ''}`}>2. Payment</div>
                <div className={`package-details-step ${paymentStep >= 3 ? 'active' : ''}`}>3. Confirm</div>
              </div>
            </div>

            <form onSubmit={handleSubmit}>
              {paymentStep === 1 && (
                <div className="package-details-payment-step">
                  <h3>Personal Details</h3>
                  <div className="package-details-form-row">
                  ...
                  <div className="package-details-form-buttons">
                    <Button type="button" className="package-details-button" onClick={() => setShowPaymentModal(false)}>Cancel</Button>
                    <Button type="button" className="package-details-button package-details-book-now-button" onClick={nextStep}>Next</Button>
                  </div>
                </div>
              )}
              ...
              {paymentStep === 2 && (
                <div className="package-details-payment-step">
                  ...
                  <div className="package-details-payment-summary">
                    <h4>Payment Summary</h4>
                    <div className="package-details-summary-row">
                      <span>Package Price:</span>
                      <span>${selectedPackage.price.split('–')[0]} x {formData.travelers} travelers</span>
                    </div>
                    <div className="package-details-summary-row package-details-total">
                      <span>Total:</span>
                      <span>${parseInt(selectedPackage.price.split('–')[0].replace(/,/g, '')) * formData.travelers}</span>
                    </div>
                  </div>
                  <div className="package-details-form-buttons">
                    <Button type="button" className="package-details-button" onClick={prevStep}>Back</Button>
                    <Button type="button" className="package-details-button package-details-book-now-button" onClick={nextStep}>Review Booking</Button>
                  </div>
                </div>
              )}
              ...
              {paymentStep === 3 && (
                <div className="package-details-payment-step">
                  ...
                  <div className="package-details-booking-summary">
                    <div className="package-details-summary-section">
                  ...
                  <div className="package-details-terms-checkbox">
                    <input type="checkbox" id="terms" required />
                    <label htmlFor="terms">I agree to the terms and conditions</label>
                  </div>
                  <div className="package-details-form-buttons">
                    <Button type="button" className="package-details-button" onClick={prevStep}>Back</Button>
                    <Button type="submit" className="package-details-button package-details-book-now-button">Confirm Booking</Button>
                  </div>
                </div>
              )}
            </form>
