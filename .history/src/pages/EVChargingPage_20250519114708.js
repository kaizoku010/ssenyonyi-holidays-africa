...
import Swril from "../media/swril.png"
      ...
      <div className="ev-header-container">
        ...
        <div className="ev-header-content">
          <div className="ev-header-text">
            <h1 className="ev-title">Mountain gorillas are an endangered species, with only around 1065 remaining in the whole world.</h1>
            <div className="ev-author-info">
              <p className="ev-author">By Deriq Sennoyni</p>
