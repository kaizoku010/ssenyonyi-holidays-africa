      ...
      <div className="why-us">
        ...
        <div className="bigger-side">
          ...
          <div className="why-us-content">
            <h3 className="why-us-title">Murchison Falls</h3>
            <p className="why-us-text">
 The critically endangered mountain gorillas in the whole world are not known to exist in captivity such as zoos but are only known to be thriving in the verdant tropical forests of Africa.
            </p>
          </div>
        </div>
      </div>
