      ...
      <div className="ev-solution-container">
        <div className="ev-solution-content">
          ...
          <div className="ev-solution-text">
            <p>To become Africa’s most trusted and innovative travel partner, known globally for curating exceptional, meaningful, and sustainable journeys that leave a lasting legacy for people, wildlife, and the planet.
