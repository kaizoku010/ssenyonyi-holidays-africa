    ...
    <div className="ev-charging-page">
        ...
        <div className="ev-header-content">
          <div className="ev-header-text">
            <h1 className="ev-title">
              Murchison Falls National Park sits on the shore of Lake Albert, in
              northwest Uganda.
            </h1>
          ...
          <div className="ev-mission-text">
            <div>
              ...
              <p className="ev-mission-description">
                Rooted in the Swahili word for “bird,” Nyonyi represents
                freedom, elegance, and the boundless spirit of exploration that
                guides our brand. We believe travel is not just about
                discovery—it’s about stewardship.
              </p>
            </div>

            <p className="ev-mission-description">
              From gorilla trekking in Bwindi Impenetrable Forest to chimpanzee
              tracking in Kibale, and game drives in Murchison Falls to Rwanda’s
              golden savannahs of Akagera National Park, we connect discerning
              travelers to the true heart of Africa. <br />
              <br />
              Every itinerary we design prioritizes conservation-first tourism,
              ensuring that your journey supports the protection of endangered
              species, preserves fragile ecosystems, and empowers communities
              safeguarding these wild spaces.
            </p>
          </div>
      ...
      <div className="ev-solution-container">
        <div className="ev-solution-content">
          ...
          <div className="ev-solution-text">
            <p>
              To become Africa’s most trusted and innovative travel partner,
              known globally for curating exceptional, meaningful, and
              sustainable journeys that leave a lasting legacy for people,
            ...
            <div>
              ...
              <p className="ev-solution-description">
                To design and deliver authentic African travel experiences that
                inspire, educate, and uplift—while fostering responsible tourism
                that directly contributes to wildlife conservation, habitat
                restoration, and sustainable livelihoods for local communities.
              </p>
      ...
      <div className="ev-team-container">
        <h2 className="ev-team-title">
          A unique eco-system waiting for you to explore!
        </h2>
      ...
      <div className="ev-partners-container">
        <div className="ev-partners-content">
          <h2 className="ev-partners-title">
            Our adventures are all made possible by our partners
          </h2>
      ...
      <div className="why-us">
        <div className="smaller-side">
          ...
          <div className="why-us-content">
            <h2 className="why-us-title">Murchison Falls</h2>
            <p className="why-us-text">
              It’s known for Murchison Falls, where the Victoria Nile River
              surges through a narrow gap over a massive drop.
            </p>
          </div>
        </div>
        <div className="bigger-side">
          <div className="spacer"></div>
          <div className="why-us-content">
            <h3 className="why-us-title">Uganda’s Mountain Gorillas</h2>
            <p className="why-us-text">
 The critically endangered mountain gorillas in the whole world are
  not known to exist in captivity such as zoos
  but are only known to be thriving in the verdant tropical forests of Africa.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="ev-cta-container">
        <div className="ev-cta-content">
          ...
          <button className="ev-cta-button">
            Contact us <span className="ev-cta-dot">•</span>
          </button>
          <p className="ev-cta-description">
            Let us help you implement the perfect EV charging solution for your
            needs.
          </p>
        </div>
      </div>
