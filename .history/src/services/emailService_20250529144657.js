...
// This service handles email template generation and sending via EmailJS
...
// Send emails via EmailJS (SIMPLE AND WORKS!)
export const sendPackageInquiryEmails = async (inquiryData) => {
  try {
    console.log('📧 Sending email with EmailJS for:', inquiryData.package_name);

    // Send to your email directly
    const result = await emailjs.send(
      'default_service', // Use your service ID here
      'template_package_inquiry', // Use your template ID here
      {
        to_name: 'Nyonyi Holidays Team',
        to_email: 'dixontheworldvsy@gmail.com',
        from_name: inquiryData.customer_name,
        from_email: inquiryData.customer_email,
        phone: inquiryData.customer_phone,
        package: inquiryData.package_name,
        duration: inquiryData.package_duration,
        price: inquiryData.package_price,
        people: inquiryData.number_of_people,
        date: inquiryData.preferred_date || 'Not specified',
    ...
    alert('✅ EMAIL SENT! Check dixontheworldvsy@gmail.com');
