...
// Initialize EmailJS
emailjs.init("YOUR_PUBLIC_KEY"); // We'll set this up
...
export const sendPackageInquiryEmails = async (inquiryData) => {
  try {
    ...
    const result = await emailjs.send(
      'service_gmail', // Gmail service
      'template_inquiry', // Template ID
      {
        ...
        package_duration: inquiryData.package_duration,
        package_price: inquiryData.package_price,
        number_of_people: inquiryData.number_of_people,
        preferred_date: inquiryData.preferred_date || 'Not specified',
