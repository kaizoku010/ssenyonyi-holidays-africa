...
const enTranslations = {
  ...
  callToAction: {
    title: "Experience Uganda's Magic",
    description: "Immerse yourself in breathtaking landscapes and unforgettable wildlife encounters.",
...
const zhTranslations = {
  ...
  callToAction: {
    title: "无限制旅行",
    description: "通过我们的导游和野生动物园体验发现乌干达的美丽。",
    locationTitle: "探索乌干达",
